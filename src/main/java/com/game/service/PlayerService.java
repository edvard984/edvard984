...
public interface PlayerService {
    ...
    List<Player> getAllPlayersList(Specification<Player> specification);

    Page<Player> getAllPlayersList(Specification<Player> specification, Pageable sortedByName);
