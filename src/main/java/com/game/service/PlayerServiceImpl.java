...
public class PlayerServiceImpl implements PlayerService{
    ...
    private boolean isValidParameters(Player player) {
    ...
    @Override
    public List<Player> getAllPlayersList(Specification<Player> specification) {
        return playerRepository.findAll(specification);
    }

    @Override
    public Page<Player> getAllPlayersList(Specification<Player> specification, Pageable pageable) {
    ...
    public Player createPlayer(Player requestPlayer) {
        ...
        if (isValidParameters(requestPlayer)) return null;;
